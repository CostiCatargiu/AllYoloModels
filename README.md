...
- 🔍 I created a script that run after each Inference task, to analyze models by evaluating detection counts and average confidence per class, enabling performance comparison.
