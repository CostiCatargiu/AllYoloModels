...
<details>
  ...
  To clone a specifi yolo model $\color{magenta}{\textsf{DownloadModel.sh}}$ is used that requires on parameter from the list (yolov5, yolov6, yolov7, yolov8, yolov9).
