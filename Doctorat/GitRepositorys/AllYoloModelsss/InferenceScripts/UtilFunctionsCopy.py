...
class MismatchDetector:
    ...
    def calculate_similarity(self, t1, t2, threshold=0.002):
    ...
    def process_detections(self, detections, path_to_metric):
        ...
        mismatched_dict, inter_frame_mismatches = self.find_mismatches_between_frames(detections, max_compare_frames=20)
