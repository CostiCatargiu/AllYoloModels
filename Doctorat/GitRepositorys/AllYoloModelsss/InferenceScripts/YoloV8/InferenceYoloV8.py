...
def infer():
    ...
    # print(project)
    # print(name)
    model.predict(source=video_path, show=True, conf=conf_thr, save=True, save_frames=False, device=device, project=project,
                  name=name, save_txt=True, iou=0.7, imgsz=640)
