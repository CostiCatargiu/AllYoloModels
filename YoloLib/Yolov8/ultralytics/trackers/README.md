...
model = YOLO("path/to/best_80epochs.pt")  # Load a custom trained model
...
yolo track model=path/to/best_80epochs.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/best_80epochs.pt tracker="bytetrack.yaml"
```
